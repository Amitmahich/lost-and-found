...
//   const [unhandledCount, setUnhandledCount] = useState(0); // ✅ unhandled reports only
...
//   // ✅ Real-time listener for only unhandled reports
//   useEffect(() => {
...
//         // 🔔 play sound only if new unhandled report comes & not on reports page
//         if (
